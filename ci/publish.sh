...
if [[ $BUILDKITE_BRANCH == "master" ]] ; then
	aws s3 cp --acl public-read "templates/mappings-${AGENT_RELEASE_STREAM}.yml" "s3://buildkite-aws-stack/${AGENT_RELEASE_STREAM}/mappings.yml"
	aws s3 cp --acl public-read build/aws-stack.json "s3://buildkite-aws-stack/${AGENT_RELEASE_STREAM}/aws-stack.json"
fi

aws s3 cp --acl public-read "templates/mappings-${AGENT_RELEASE_STREAM}.yml" "s3://buildkite-aws-stack/${AGENT_RELEASE_STREAM}/${BUILDKITE_BRANCH}/mappings.yml"
