...
# some can be overridden, some can't
...
: "${SECRETS_PLUGIN_ENABLED:=$SECRETS_PLUGIN_ENABLED}"
: "${ECR_PLUGIN_ENABLED:=$ECR_PLUGIN_ENABLED}"
: "${DOCKER_LOGIN_PLUGIN_ENABLED:=$DOCKER_LOGIN_PLUGIN_ENABLED}"
EOF
