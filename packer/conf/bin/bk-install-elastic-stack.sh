...
export SECRETS_PLUGIN_ENABLED=$SECRETS_PLUGIN_ENABLED
export ECR_PLUGIN_ENABLED=$ECR_PLUGIN_ENABLED
export DOCKER_LOGIN_PLUGIN_ENABLED=$DOCKER_LOGIN_PLUGIN_ENABLED
EOF
