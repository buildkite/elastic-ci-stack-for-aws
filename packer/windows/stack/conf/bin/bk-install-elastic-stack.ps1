...
set_always         "BUILDKITE_CACHE_S3_BUCKET" "$Env:BUILDKITE_CACHE_S3_BUCKET"
set_always         "BUILDKITE_CACHE_S3_REGION" "$Env:BUILDKITE_CACHE_S3_REGION"
...
cache-s3-bucket-name="${Env:BUILDKITE_CACHE_S3_BUCKET}"
cache-s3-region="${Env:BUILDKITE_CACHE_S3_REGION}"
