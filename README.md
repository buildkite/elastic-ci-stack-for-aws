...
**If you're viewing this at https://github.com/buildkite/elastic-ci-stack-for-aws, you're reading the documentation for the master branch. View [documentation for the latest stable release (2.0.0)](https://github.com/buildkite/elastic-ci-stack-for-aws/blob/v2.0.0/README.md).**
