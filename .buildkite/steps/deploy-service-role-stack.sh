...
role_arn="$(aws cloudformation describe-stacks --stack-name buildkite-elastic-ci-stack-service-role --region us-east-1 --query "Stacks[0].Outputs[?OutputKey=='RoleArn'].OutputValue" --output text)"
